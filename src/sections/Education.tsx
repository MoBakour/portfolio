...
const EducationCard = ({ education }: IEducationCard) => {
    return (
        <a href={education.link} target="_blank">
            <div className="group-hover/container:opacity-60 max-md:opacity-100! hover:opacity-100! group/card flex flex-col gap-4 p-4 py-4 transition rounded-lg hover:bg-card-bg/50 hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] hover:drop-shadow-lg max-md:hover:bg-transparent max-md:hover:shadow-none max-md:hover:drop-shadow-none cursor-pointer">
                <header>
                    <div className="flex justify-between items-center max-md:flex-col max-md:items-start">
                        <h2 className="text-xl font-bold group-hover/card:text-primary max-md:group-hover/card:text-text transition">
